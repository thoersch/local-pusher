        ...
        var i = function() {
            ...
            t.prototype.encode = function(t) {
                ...
                if (r > 0) {
                    ...
                    e += this._encodeByte(o >>> 18 & 63),
                    e += this._encodeByte(o >>> 12 & 63),
                    e += 2 === r ? this._encodeByte(o >>> 6 & 63) : this._paddingCharacter || "",
    ...
    , function(t, e, n) {
        ...
        var o, r = function() {
            ...
            urls: {
                ...
                encryptedChannelSupport: {
                    fullUrl: "http://github.com/pusher/pusher-js/tree/cc491015371a4bde5743d1c87a0fbac0feb53195#encrypted-channel-support"
                }
            }
        }, p = function(t) {
            var e, n = h.urls[t];
        ...
        function(t, e) {
            ...
            function e(e) {
                ...
                return Object.setPrototypeOf(o, n.prototype),
                o
            }
            return l(e, t),
            e
            ...
            var o, r = this;
            for (var i in (o = _e.createXHR()).open("POST", r.options.authEndpoint, !0),
        ...
        for (var S = String.fromCharCode, k = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", C = {}, T = 0, P = k.length; T < P; T++)
            C[k.charAt(T)] = T;
        var O = function(t) {
        ...
        function H(t) {
            ...
            for (var o = 0; o < e.length; o++) {
                var r = e[o];
                for (var i in r)
                    r[i] && r[i].constructor && r[i].constructor === Object ? t[i] = H(t[i] || {}, r[i]) : t[i] = r[i]
            }
            return t
        }
        function q() {
            for (var t = ["Pusher"], e = 0; e < arguments.length; e++)
                "string" == typeof arguments[e] ? t.push(arguments[e]) : t.push(Y(arguments[e]));
            return t.join(" : ")
        }
        function B(t, e) {
                ...
                function t(o, r) {
                    ...
                    case "object":
                        ...
                        "[object Array]" === Object.prototype.toString.apply(o))
                            ...
                            for (s in c = {},
                            o)
                                Object.prototype.hasOwnProperty.call(o, s) && (c[s] = t(o[s], r + "[" + JSON.stringify(s) + "]"));
                        return c;
                    case "number":
                    case "string":
                    case "boolean":
        ...
        var $ = new (function() {
          ...
          , Z = function() {
            ...
            return t.prototype.send = function(t) {
                ...
                e.errorScript && o.insertBefore(e.errorScript, e.script.nextSibling)
            }
            ,
        ...
        var ut = function() {
          ...
          , pt = function(t) {
            function e(e, n, o, r, i) {
                ...
                return s.initialize = _e.transportConnectionInitializer,
                s.hooks = e,
                s.name = n,
                s.priority = o,
                s.key = r,
        ...
        var kt = bt
                ...
                var i = this.transport.createConnection(t, e, n, o)
                  ...
                  , a = function(t) {
                    ...
                    1002 === t.code || 1003 === t.code)
                        ...
                        var e = M.now() - s;
                        e < 2 * r.maxPingDelay && (r.manager.reportDeath(),
          ...
          , Ot = {
            decodeMessage: function(t) {
                try {
                    ...
                    return e.user_id && (o.user_id = e.user_id),
                    o
                } catch (e) {
                    throw {
                ...
                t.prototype.authorize.call(this, e, (function(t, e) {
                    if (!t) {
                        if (void 0 === (e = e).channel_data) {
                            ...
                            return $.error("Invalid auth response for channel '" + o.name + "',expected 'channel_data' field. " + r),
            ...
            e.prototype.authorize = function(e, n) {
                ...
                t.prototype.authorize.call(this, e, (function(t, e) {
                    if (t)
                        ...
                        r ? (o.key = Object(Ut.decode)(r),
                        delete e.shared_secret,
                        n(null, e)) : n(new Error("No shared_secret key in auth payload for encrypted channel: " + o.name), null)
                    }
                }
                ))
            }
                    ...
                    if (e.ciphertext && e.nonce) {
                        ...
                        if (o.length < this.nacl.secretbox.overheadLength)
                            ...
                            if (r.length < this.nacl.secretbox.nonceLength)
                                $.error("Expected encrypted event nonce length to be " + this.nacl.secretbox.nonceLength + ", got: " + r.length);
                            else {
                                var i = this.nacl.secretbox.open(o, r, this.key);
                                if (null === i)
                                    return $.debug("Failed to decrypt an event, probably because it was encrypted with a different key. Fetching a new key from the authEndpoint..."),
                        ...
                        $.error("Unexpected format for encrypted event, expected object with `ciphertext` and `nonce` fields, got: " + e);
                else
                    $.debug("Received encrypted event before key has been retrieved from the authEndpoint")
            }
            ,
          ...
          , Wt = function(t) {
            ...
            e.prototype.resetActivityCheck = function() {
                var t = this;
                this.stopActivityCheck(),
                this.connection && !this.connection.handlesActivityChecks() && (this.activityTimer = new I(this.activityTimeout,(function() {
                    t.sendActivityCheck()
                }
                )))
            }
            ...
            t.prototype.connect = function(t, e) {
                ...
                var s = M.now()
                  , c = r.pop().connect(t, (function o(i, a) {
                    i ? (ee(n),
                    r.length > 0 ? (s = M.now(),
                    c = r.pop().connect(t, o)) : e(i)) : (!function(t, e, n) {
        ...
        var se, ce = function(t, e, n) {
            ...
            var i, s = Object.assign({}, e, {
                ...
                minPingDelay: 1e4,
                maxPingDelay: t.activityTimeout
            }), l = r("ws", "ws", 3, s, h), f = r("wss", "ws", 3, c, h), d = r("sockjs", "sockjs", 1, a), y = r("xhr_streaming", "xhr_streaming", 1, a, p), g = r("xdr_streaming", "xdr_streaming", 1, a, p), v = r("xhr_polling", "xhr_polling", 1, a), b = r("xdr_polling", "xdr_polling", 1, a), m = new Yt([l],u), w = new Yt([f],u), _ = new Yt([d],u), S = new Yt([new oe(ie(y),y,g)],u), k = new Yt([new oe(ie(v),v,b)],u), C = new Yt([new oe(ie(S),new $t([S, new ne(k,{
                delay: 4e3
            })]),k)],u), T = new oe(ie(C),C,_);
            ...
            ,
            e.prototype.close = function() {
                this.unloader && (_e.removeUnloadListener(this.unloader),
                this.unloader = null),
        ...
        var ye, ge = function() {
            function t(t, e) {
                this.hooks = t,
                this.session = de(1e3) + "/" + function(t) {
                    for (var e = [], n = 0; n < t; n++)
            ...
            t.prototype.sendRaw = function(t) {
                if (this.readyState !== pe.OPEN)
                    return !1;
                try {
                    return _e.createSocketRequest("POST", fe((e = this.location,
                    n = this.session,
            ...
            t.prototype.onChunk = function(t) {
                var e;
                if (200 === t.status)
                    switch (this.readyState === pe.OPEN && this.onActivity(),
                    t.data.slice(0, 1)) {
                    case "o":
            ...
            t.prototype.onOpen = function(t) {
                var e, n, o;
                this.readyState === pe.CONNECTING ? (t && t.hostname && (this.location.base = (e = this.location.base,
                n = t.hostname,
                (o = /(http?:\/\/)([^\/:]+)((\/|:)?.*)/.exec(e))[1] + n + o[3])),
        ...
        var Pe = _e.Transports
          , Oe = function(t, e, n, o, r, i) {
            ...
            s = new Ce(e,o,i ? i.getAssistant(c) : c,r)) : s = Ee,
            s
        }
          , Ee = {
            isSupported: function() {
        ...
        function Re(t) {
            return "http:" === _e.getProtocol() || !1 !== t.forceTLS
        }
        function je(t) {
        ...
        var De = function() {
            function t(e, n) {
                ...
                this.connection.bind("connected", (function() {
                    i.subscribeAll(),
                    i.timelineSender && i.timelineSender.send(i.connection.isUsingTLS())
                }
                )),
